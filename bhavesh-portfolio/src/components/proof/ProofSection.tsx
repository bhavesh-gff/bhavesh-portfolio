...
export default function ProofSection({ onCursorChange }: ProofSectionProps) {
  return (
    <section id="proof" className="py-24 px-4 flex justify-center border-t border-white/5">
      <div className="w-full max-w-7xl">
        <div className="flex items-center gap-3 mb-4">
          <span className="font-mono text-xs text-[#8B5CF6]">05</span>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="font-mono text-xs text-[#64748B]">{cred.year}</span>
                </div>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                <span className="text-[11px] font-mono text-[#8B5CF6]">VERIFIED CREDENTIAL</span>
